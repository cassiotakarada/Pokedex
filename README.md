...
<p align="justify">First project using a API. In this project I have made a Pokedex with the following technologies: HTML, CSS and Java Script. The author of this project is the YouTube channel "Manual do Dev".<p>
